...
require('lazy').setup({
    ...
    opts = {
      strategies = {
        chat = {
          ...
          keymaps = {
            send = {
              modes = { n = '<enter>', i = '<enter>' },
              opts = {},
            },
            close = {
              modes = { n = '<leader>aa', i = '<C-q>' },
              opts = {},
            },
          },
        },
      ...
      opts.adapters.openai_compatible = function()
        return require('codecompanion.adapters').extend('openai_compatible', {
          env = {
            ...
            api_key = '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',
...

  {
    ...
    event = 'InsertEnter', -- Load the plugin on InsertEnter event
    config = function()
      require('nvim-autopairs').setup {
        -- Your setup options can go here
        -- Example: enable auto pairing for specific filetypes or customize other behaviors
        check_ts = true, -- Enable treesitter-based checks for matching pairs
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- Windows fix for file name escaping
